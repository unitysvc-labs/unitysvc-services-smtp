...
Identical to `smtp-to-email`'s — see its [description](../smtp-to-email/email-description.md). The receiver gets the same lossless email JSON regardless of which enrollment routed it.
