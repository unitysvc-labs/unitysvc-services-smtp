...
Identical to `smtp-to-msg`'s — every receiver gets the strict `{title, body, type, format}` envelope. See the [free variant's description](../smtp-to-msg/msg-description.md) for the mapping table.
